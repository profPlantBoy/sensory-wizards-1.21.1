...
public record LearnedSpellsComponent(Set<String> spells) {
    ...
    public static final PacketCodec<RegistryByteBuf, LearnedSpellsComponent> PACKET_CODEC = PacketCodecs.collection(HashSet::new, PacketCodecs.STRING)
            .xmap(LearnedSpellsComponent::new, LearnedSpellsComponent::spells);
